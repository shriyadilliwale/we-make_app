...
public class ResultItemAdapter extends ArrayAdapter<com.example.wemakeapp.ResultItem> {
    ...
    private List<com.example.wemakeapp.ResultItem> items;
    private Context context;

    public ResultItemAdapter(@NonNull Context context, List<com.example.wemakeapp.ResultItem> items) {
    ...
    public View getView(int position, @Nullable View view, @NonNull ViewGroup parent) {
        ...
        com.example.wemakeapp.ResultItem resultItem = items.get(position);
